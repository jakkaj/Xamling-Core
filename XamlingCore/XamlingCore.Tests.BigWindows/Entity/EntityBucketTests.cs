...
using XamlingCore.Tests.BigWindows.Entity;
...
namespace XamlingCore.Tests.iOS.Tests.EntityTests
{
    ...
    public class EntityBucketTests : TestBase
    {
        ...
        {
            var entityManager = Container.Resolve<IEntityManager<EntityInstanceTests.TestEntity>>();
        ...
        private List<EntityInstanceTests.TestEntity> _testData()
        {
            var l = new List<EntityInstanceTests.TestEntity>();

            for (var i = 0; i < 100; i++)
            {
                l.Add(new EntityInstanceTests.TestEntity { Id = Guid.NewGuid(), IsSomething = i % 2 == 0 });
            }
        ...
        private List<EntityInstanceTests.TestEntity2> _testData2()
        {
            var l = new List<EntityInstanceTests.TestEntity2>();

            for (var i = 0; i < 15; i++)
            {
                l.Add(new EntityInstanceTests.TestEntity2 { Id = Guid.NewGuid(), IsSomething = i % 2 == 0 });
            }
