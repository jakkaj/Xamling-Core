...
//namespace XamlingCore.Tests.Android.Tests.CacheTests
//{
//    [TestFixture]
...
//                var c1Out2 = await cache.GetEntity<List<CacheTest1>>("List1");
//                var c2Out2 = await cache.GetEntity<List<CacheTest2>>("List2");

//                var c1OutMissingBadName = await cache.GetEntity<List<CacheTest1>>("List3");

//                Assert.IsNotNull(c2Out2);
//                Assert.IsNull(c1Out2);
//                Assert.IsNull(c1OutMissingBadName);

//                var c1Out3 = await cache.GetEntity<List<CacheTest2>>("List1");
//                var c2Out3 = await cache.GetEntity<List<CacheTest1>>("List2");

//                Assert.IsNull(c2Out3);
//                Assert.IsNull(c1Out3);

//                var f1 = await cache.GetEntity<CacheTest1>("F1");
