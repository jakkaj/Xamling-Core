By downloading, you agree to be bound by the [Terms](http://www.google.com/analytics/tos.html) and [SDK Policy](https://developers.google.com/analytics/devguides/collection/protocol/policy) that govern use of the Google Analytics SDKs.
