...
namespace XamlingCore.iOS.Controls.Loader
{
    ...
    {
        protected LoadingOverlayViewBase(RectangleF frame)
            : base(frame)
        {
    ...
    //Pinched from Xamarin recipe
    //http://developer.xamarin.com/recipes/ios/standard_controls/popovers/display_a_loading_message/
    public class LoadingOverlayView : LoadingOverlayViewBase
    {
        // control declarations
        UIActivityIndicatorView activitySpinner;
        UILabel loadingLabel;

        public LoadingOverlayView(RectangleF frame)
            : base(frame)
        {
            // configurable bits
